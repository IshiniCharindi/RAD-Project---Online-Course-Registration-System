            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ms-auto">
                        <a class="nav-link px-5 py-2" aria-current="page" href="index.jsp">Home</a>
                        <a class="nav-link px-5 py-2" href="myCourse.jsp">My Courses</a>
                        <a class="nav-link px-5 py-2" href="logOut.jsp">Log Out</a>
